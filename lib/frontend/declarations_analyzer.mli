...
(** Checks that each variable accessed or function called is actually declared taking the [current_scope] of the expression [expr] *)
val check_accesses: Ast.expr -> Symbol.t Symbol_table.t -> (unit, Location.code_pos * Semantic_errors.t) result